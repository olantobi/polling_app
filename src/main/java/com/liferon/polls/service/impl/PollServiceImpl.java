package com.liferon.polls.service.impl;

import com.liferon.polls.exception.BadRequestException;
import com.liferon.polls.exception.ResourceNotFoundException;
import com.liferon.polls.model.*;
...
import com.liferon.polls.util.ModelMapper;
...
public class PollServiceImpl implements PollService {
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        // Vote saved. Return updated poll response now
    ...
    private Map<Long, Long> getChoiceVoteCountMap(List<Long> pollIds) {
        // Retrieve vote counts at every choice belonging to the given pollids
